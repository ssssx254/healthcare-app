          ...
          <>
            <Card className="mb-3">
              <View className="flex-row items-center justify-between">
                <View>
                  <Text className="text-sm font-semibold text-app-text">{conversation.customer.name}</Text>
                  <Text className="mt-0.5 text-xs text-app-text-muted">{conversation.providerTitle || "Эмнэлэг"}</Text>
                </View>
            ...
            <Card className="mt-4">
              {isLoadingMessages ? (
                <View className="mb-2 flex-row items-center gap-1.5">
                  ...
                  <View className="h-2 w-2 rounded-full bg-slate-400" />
                  <View className="h-2 w-2 rounded-full bg-slate-400" />
                  <Text className="ml-1 text-xs text-app-text-muted">Үйлчлүүлэгч бичиж байна…</Text>
                </View>
              ) : null}
